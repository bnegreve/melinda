...
inline void aligned16_malloc (tid_list* &aligned, void* &real_inimg, unsigned int spaceneeded) {
  real_inimg = malloc(spaceneeded + 15); 
  aligned  = (tid_list*) ( (unsigned int)((char*)real_inimg + 15) & 0xFFFFFFF0);
}
